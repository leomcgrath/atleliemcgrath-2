...
export default async function About() {
  const title = await getContentWithFallback("about_title", "ABOUT ATLE");
  const introText = await getContentWithFallback(
    "about_intro_text",
  ...
  const descriptionText = await getContentWithFallback(
  ...
  const buttonText = await getContentWithFallback("about_button_text", "READ MORE");
