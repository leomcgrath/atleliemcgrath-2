  ...
  return (
    <header className="absolute top-0 left-0 w-full z-50">
      ...
      <div className="relative w-full">
        ...
        <div className="flex items-center min-h-[75px] md:min-h-[85px] relative z-50">
          {/* Left section - Logo (positioned to the left of yellow bar) */}
          <div className="flex items-center px-4 md:px-6 py-3 md:py-4 relative z-50">
            {/* Logo image */}
            <div className="relative w-24 h-14 md:w-32 md:h-[72px] lg:w-40 lg:h-24 flex-shrink-0">
              <Image
          ...
          <nav className="bg-[#FFD700] px-4 md:px-6 lg:px-8 py-3 md:py-4 flex items-center justify-between absolute left-[40%] right-0 min-h-[75px] md:min-h-[85px] z-50">
